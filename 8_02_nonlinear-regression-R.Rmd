...
Our goal is to predict optimal density from protein concentration, meaning `pconc` will be the response variable and `density` will be the predictor variable.
